...
def test_sophisticated_rr_system():
    ...
    try:
        ...
        response = requests.get("https://ai-tradingpro.preview.emergentagent.com/api/decisions", timeout=10)
    ...
    try:
        # Trigger trading
        response = requests.post("https://ai-tradingpro.preview.emergentagent.com/api/start-trading", 
                               json={}, timeout=30)
        if response.status_code == 200:
