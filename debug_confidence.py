...
def debug_ia2_confidence():
    ...
    try:
        # Get decisions
        response = requests.get("https://dual-ai-trader-2.preview.emergentagent.com/api/decisions", timeout=10)
        ...
        response = requests.get("https://dual-ai-trader-2.preview.emergentagent.com/api/analyses", timeout=10)
        if response.status_code == 200:
        ...
        response = requests.get("https://dual-ai-trader-2.preview.emergentagent.com/api/opportunities", timeout=10)
        if response.status_code == 200:
