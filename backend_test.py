...
class DualAITradingBotTester:
    ...
    def test_ia1_master_pattern_prioritization(self):
        ...
        pythusdt_case_working = pythusdt_found and pythusdt_analysis and pythusdt_analysis['has_master_pattern']
        ...
        print(f"      PYTHUSDT Test Case: {'✅' if pythusdt_case_working else '❌'}")
