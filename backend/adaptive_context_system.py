...
class MarketContext:
    ...
    current_regime: MarketRegime  # Simplified regimes aligned with AI backtest capabilities
...
class AdaptiveContextSystem:
    ...
    async def analyze_current_context(self, market_data: Dict[str, Any]) -> MarketContext:
        ...
        try:
            ...
            context = MarketContext(
                ...
                stochastic_environment=stochastic_environment,
                bollinger_environment=bollinger_environment,
                technical_confluence=technical_confluence,
                indicators_divergence=indicators_divergence,
    ...
    def _detect_practical_market_regime(self, price_change: float, volatility: float, 
        ...
        return base_regime
    # Simplified regime detection - no complex phase methods needed
