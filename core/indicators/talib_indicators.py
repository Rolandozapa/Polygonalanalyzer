...
class TALibIndicators:
    ...
    def calculate_all_indicators(self, df: pd.DataFrame, symbol: str = "UNKNOWN") -> TechnicalAnalysisComplete:
        ...
        try:
            ...
            analysis = TechnicalAnalysisComplete(
                ...
                # ❌ INDICATEURS MOMENTUM REDONDANTS SUPPRIMÉS
    ...
    def _calculate_momentum_indicators(self, high: np.array, low: np.array, close: np.array) -> Dict[str, Any]:
        ...
        try:
            ...
            # ✅ INDICATEURS MOMENTUM ESSENTIELS SEULEMENT (RSI + MACD)
            # Williams %R, CCI, ROC supprimés pour éviter redondance avec RSI
